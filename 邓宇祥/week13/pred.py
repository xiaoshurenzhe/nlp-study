...
if tuning_tactics == "lora_tuning":
    ...
    loaded_weight = torch.load('model_outputoutput/p_tuning.pth')
elif tuning_tactics == "prompt_tuning":
    loaded_weight = torch.load('model_outputoutput/prompt_tuning.pth')
elif tuning_tactics == "prefix_tuning":
    loaded_weight = torch.load('model_outputoutput/prefix_tuning.pth')
